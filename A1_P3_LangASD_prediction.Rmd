...
mean(test_RMSE)
mean(train_RMSE)
#The model is not a good model, because the model has much more error when predicting from the test data. 
...
mean(test_RMSE3)
mean(train_RMSE3)
#The model is a better model because the error difference is smaller. 
...
TDmodel = lmer(CHI_MLU ~ Visit + MOT_MLU + verbalIQ + (1 + Visit|ID), TDtrain, REML = FALSE)
